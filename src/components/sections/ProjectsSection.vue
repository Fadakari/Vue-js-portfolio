          ...
          <div v-for="project in projects" :key="project.title" class="project-card anim-stagger">
            ...
            <div class="card-content">
              ...
              <div class="card-footer">
                <a :href="project.liveUrl" target="_blank" class="card-button primary">Live Demo</a>
                <a :href="project.githubUrl" target="_blank" class="card-button secondary">GitHub</a>
              </div>
            </div>
          </div>
        </div>
...
const projects = ref([
  ...
  },
  {
    ...
    description: `redefining Personal Branding with Nuxt 3 & GSAP. Excited to unveil my latest project: A high-performance personal portfolio website designed for Behzad Heydari.`,
  ...
  {
    title: 'Mobile – Complete Redesign & Development', 
    description: `I rebuilt this website from scratch using React & Next.js, based on a completely different template provided by the client. I redesigned the entire front-end appearance and integrated several custom APIs to enhance functionality and user experience. The result is a fast, SEO-friendly, and dynamic online store for mobile devices.`,
    image: yazdMobile,
    tags: ['React Js', 'Tailwind CSS', 'TypeScript', 'Next Js', 'Gsap'],
